...
-- Dumping database structure for stunt
CREATE DATABASE IF NOT EXISTS `stunt` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `stunt`;

-- Dumping structure for table stunt.games
CREATE TABLE IF NOT EXISTS `games` (
  ...
  `tanggal_release` varchar(255) NOT NULL,
